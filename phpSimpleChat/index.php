...
fwrite($hist, "<span style=\"color:".$color."\"><em><b>$user</b> <small>, a las ".date("H:i:s")." dijo:</small></em> $mensaje" . "</span></br>" . PHP_EOL); //insertamos el texto
fwrite($hist, "<script>beep();</script>" . PHP_EOL); //insertamos el texto
